...
const CarFinderApp = () => {
  ...
  const quizQuestions = [
    {
      ...
      options: [
        { value: 'under30', label: 'Under $30k', icon: '💰', desc: 'Budget friendly' },
        { value: '30-40', label: '$30k - $40k', icon: '💵', desc: 'Sweet spot' },
        { value: '40-50', label: '$40k - $50k', icon: '💳', desc: 'Mid-range' },
        { value: '50-65', label: '$50k - $65k', icon: '💎', desc: 'Premium' },
        { value: '65-80', label: '$65k - $80k', icon: '👑', desc: 'Luxury territory' },
        { value: 'over80', label: 'Over $80k', icon: '🚀', desc: 'No limits' }
      ]
    },
    {
      id: 'fuelType',
      ...
      maxSelections: 2,
      options: [
        { value: 'ev', label: 'Full Electric (EV)', icon: '⚡', desc: 'Zero emissions' },
        { value: 'phev', label: 'Plug-in Hybrid', icon: '🔋', desc: 'Electric + gas backup' },
        { value: 'hybrid', label: 'Hybrid', icon: '🌿', desc: 'Great MPG, no charging' },
        { value: 'gas', label: 'Gas', icon: '⛽', desc: 'Traditional' },
        { value: 'any', label: 'Open to anything', icon: '🤷', desc: 'Show all options' }
      ]
    },
    {
      id: 'size',
      ...
      options: [
        { value: 'compact', label: 'Compact SUV', icon: '🚙', desc: 'RAV4, CR-V size' },
        { value: 'midsize', label: 'Mid-size SUV', icon: '🚐', desc: 'Pilot, Sorento size' },
        { value: 'fullsize', label: 'Full-size SUV', icon: '🚚', desc: 'Highlander, Telluride size' },
        { value: 'need3row', label: '3-row required', icon: '👨‍👩‍👧‍👦', desc: 'Must have 3rd row' },
        { value: 'prefer2row', label: '2-row preferred', icon: '👫', desc: 'Don\'t need 3rd row' }
      ]
    },
    {
      id: 'newUsed',
      ...
      options: [
        { value: 'new', label: 'New', icon: '✨', desc: 'Latest models, full warranty' },
        { value: 'cpo', label: 'Certified Pre-Owned', icon: '🔍', desc: 'Used with warranty' },
        { value: 'used', label: 'Used', icon: '💰', desc: 'Best value' }
      ]
    },
    {
      id: 'ageMax',
      ...
      options: [
        { value: 'under1', label: '< 1 year old', icon: '🆕', desc: '2025-2026 only' },
        { value: '1-3', label: '1-3 years old', icon: '📅', desc: '2023-2025' },
        { value: '3-5', label: '3-5 years old', icon: '📆', desc: '2021-2023' },
        { value: '5plus', label: '5+ years old', icon: '💵', desc: '2020 or older OK' },
        { value: 'any', label: 'Any age', icon: '🤷', desc: 'Show everything' }
      ]
    },
    {
      id: 'personality',
      ...
      options: [
        { value: 'optimizer', label: 'The Optimizer', icon: '🎯', desc: 'Data-driven decisions' },
        { value: 'earlyAdopter', label: 'Early Adopter', icon: '⚡', desc: 'Want latest tech first' },
        { value: 'maximalist', label: 'The Maximalist', icon: '🏔️', desc: 'Space & comfort priority' },
        { value: 'statementMaker', label: 'Statement Maker', icon: '✨', desc: 'Style matters' },
        { value: 'noDrama', label: 'No-Drama Driver', icon: '🛡️', desc: 'Boring reliability' }
      ]
    },
    {
      id: 'looks',
      ...
      options: [
        { value: 'future', label: 'Futuristic', icon: '🚀', desc: 'Ioniq 5, EV9 vibes' },
        { value: 'sleek', label: 'Sleek/Sporty', icon: '✨', desc: 'Mazda, Audi vibes' },
        { value: 'rugged', label: 'Rugged/Boxy', icon: '🏔️', desc: 'Bronco, R1S vibes' },
        { value: 'luxury', label: 'Luxury', icon: '👑', desc: 'Premium materials' },
        { value: 'practical', label: 'Don\'t care', icon: '📦', desc: 'Function over form' }
      ]
    },
    {
      id: 'trust',
      ...
      options: [
        { value: 'proven', label: 'Proven Data', icon: '📊', desc: 'JD Power, Consumer Reports' },
        { value: 'reddit', label: 'Real Owners', icon: '💬', desc: 'Reddit, owner forums' },
        { value: 'expert', label: 'Expert Reviews', icon: '📰', desc: 'Car & Driver, MotorTrend' },
        { value: 'new', label: 'Early Adopter', icon: '🎯', desc: 'Willing to try new models' }
      ]
    },
    {
      id: 'awd',
      ...
      options: [
        { value: 'yes', label: 'Yes, need AWD', icon: '❄️', desc: 'Snow, off-road, peace of mind' },
        { value: 'no', label: 'No, FWD/RWD fine', icon: '🌤️', desc: 'Save money & weight' }
      ]
    },
    {
      id: 'brands',
      ...
      maxSelections: 5,
      options: [
        { value: 'japanese', label: 'Japanese', icon: '🇯🇵', desc: 'Toyota, Honda, Mazda' },
        { value: 'korean', label: 'Korean', icon: '🇰🇷', desc: 'Hyundai, Kia, Genesis' },
        { value: 'american', label: 'American', icon: '🇺🇸', desc: 'Ford, Rivian, Tesla' },
        { value: 'european', label: 'European', icon: '🇪🇺', desc: 'VW, BMW, Volvo' },
        { value: 'any', label: 'No preference', icon: '🌍', desc: 'Best car wins' }
      ]
    },
    {
      id: 'techFeatures',
      ...
      maxSelections: 6,
      options: [
        { value: 'hud', label: 'Heads-Up Display', icon: '🎯', desc: 'HUD projection' },
        { value: 'adaptiveCruise', label: 'Adaptive Cruise', icon: '🚗', desc: 'Smart cruise control' },
        { value: 'camera360', label: '360° Camera', icon: '📷', desc: 'Surround view' },
        { value: 'wirelessCarPlay', label: 'Wireless CarPlay', icon: '📱', desc: 'No cables' },
        { value: 'selfParking', label: 'Self-Parking', icon: '🅿️', desc: 'Auto park assist' },
        { value: 'none', label: 'Don\'t care', icon: '🤷', desc: 'Tech not priority' }
      ]
    },
    {
      id: 'comfortFeatures',
      ...
      maxSelections: 6,
      options: [
        { value: 'heatedSteering', label: 'Heated Steering Wheel', icon: '🔥', desc: 'Warm hands' },
        { value: 'heated2ndRow', label: 'Heated 2nd Row', icon: '♨️', desc: 'Rear heated seats' },
        { value: 'ventilatedSeats', label: 'Ventilated Seats', icon: '❄️', desc: 'Cooled seats' },
        { value: 'panoramicRoof', label: 'Panoramic Roof', icon: '🌅', desc: 'Big sunroof' },
        { value: 'massagingSeats', label: 'Massaging Seats', icon: '💆', desc: 'Luxury comfort' },
        { value: 'none', label: 'Don\'t care', icon: '🤷', desc: 'Comfort not priority' }
      ]
    },
    {
      id: 'performance',
      ...
      options: [
        { value: 'fast', label: 'Want < 5s (fast)', icon: '🏁', desc: '0-60 under 5 seconds' },
        { value: 'peppy', label: 'Prefer < 7s (peppy)', icon: '🚀', desc: '0-60 under 7 seconds' },
        { value: 'dontcare', label: 'Don\'t care about speed', icon: '😴', desc: 'Gets me there' }
      ]
    },
    {
      id: 'cargoTowing',
      ...
      options: [
        { value: 'towing', label: 'Need towing 5000+ lbs', icon: '🚛', desc: 'Boats, trailers' },
        { value: 'cargo', label: 'Need cargo 40+ cu.ft', icon: '📦', desc: 'Lots of stuff' },
        { value: 'standard', label: 'Standard is fine', icon: '🎒', desc: 'Normal use' }
      ]
    },
    {
      id: 'keepDuration',
      ...
      options: [
        { value: 'short', label: '2-3 years', icon: '⚡', desc: 'Lease or flip' },
        { value: 'medium', label: '5-7 years', icon: '📊', desc: 'Typical ownership' },
        { value: 'long', label: '10+ years', icon: '🏆', desc: 'Drive forever' }
      ]
    }
  ];
  ...
  const chargingQuestion = {
    ...
    options: [
      { value: 'yes', label: 'Yes', icon: '🔌', desc: 'Garage/driveway outlet' },
      { value: 'nearby', label: 'Chargers nearby', icon: '📍', desc: 'Public charging works' },
      { value: 'no', label: 'No home charging', icon: '⛽', desc: 'Need gas backup' }
    ]
  };
  ...
  // Personality types
  const personalities = {
    optimizer: { name: 'The Optimizer', icon: '🎯', desc: 'You run the numbers and trust the data' },
    earlyAdopter: { name: 'The Early Adopter', icon: '⚡', desc: 'You want the future first' },
    maximalist: { name: 'The Maximalist', icon: '🏔️', desc: 'Space and comfort above all' },
    statementMaker: { name: 'The Statement Maker', icon: '✨', desc: 'Your car reflects who you are' },
    noDrama: { name: 'The No-Drama Driver', icon: '🛡️', desc: 'Boring reliability is perfect' }
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-950 to-black text-white">
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="text-center text-slate-500 text-sm">
            <p>Free to use • No dealer spam • Honest recommendations</p>
          </div>
        </div>
      </div>
    );
          ...
          {currentQ.multiSelect && tempMultiSelect.length > 0 && tempMultiSelect.length < (currentQ.maxSelections || 2) && (
            <div className="text-center mt-6">
              <p className="text-slate-400 text-sm">
                {tempMultiSelect.length}/{currentQ.maxSelections || 2} selected • Pick {(currentQ.maxSelections || 2) - tempMultiSelect.length} more
              </p>
            </div>
          )}
        </div>
